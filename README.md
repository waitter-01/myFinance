<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/版本-v0.8.5-6B7280" alt="v0.8.5">
  </p>
</div>
...
当前版本为 **v0.8.5**，导入预览已重构为支持拖动、最大化和自由缩放的独立窗口，并提供响应式控件布局和可靠的末条定位。完整变更内容参见 [CHANGELOG.md](CHANGELOG.md)。
...
artifacts\DuxiuLedger-v0.8.5-win-x64.zip
```
...
```text
artifacts\installer\DuxiuLedger-Setup-v0.8.5-win-x64.exe
```
...
```powershell
git tag -a v0.8.5 -m "版本：发布 v0.8.5"
